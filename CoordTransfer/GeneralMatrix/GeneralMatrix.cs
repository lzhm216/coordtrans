...
namespace Matrix
{
	...
	public class GeneralMatrix : System.ICloneable, System.Runtime.Serialization.ISerializable, System.IDisposable
	{
        ...
        public static GeneralMatrix RandomInt(int m, int n)
        {
            System.Random random = new System.Random();
        ...
        /// </summary>
        public static string ConvertToString(GeneralMatrix matrix)
        {
            string str = "";
            for (int i = 0; i < matrix.m; i++)
            {
                for (int j = 0; j < matrix.n; j++)
                    str += matrix.GetElement(i, j).ToString() + " ";
                str += "\r\n";
            }
            return str;
        }
